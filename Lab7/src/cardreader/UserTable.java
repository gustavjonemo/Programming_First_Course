...
public class UserTable {
	...
	/**
	 * Testmetod för binärsökningen: går igenom alla användare och kollar att
	 * deras kortnummer kan sökas upp. Om något kortnummer inte kunde sökas upp
	 * returneras detta. Annars, om alla sökningar lyckades, returneras 0.
	 */
	public int testFind() {
		for (int i = 0; i < n; i++) {
	...
	/**
	 * Slår upp den användare som har det givna namnet. Om flera sådana
	 * användare finns returneras den första i vektorn. Om ingen sådan användare
